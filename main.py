...
def train_model(model, train_loader, optimizer, criterion, epochs):
    ...
    for epoch in range(epochs):
        ...
        torch.save(model.state_dict(), str(f"epoch_{epoch_cout}_",'alexnet_finetuning.pth'))
